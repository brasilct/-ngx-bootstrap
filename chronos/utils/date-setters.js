...
export function setFullYear(date, value, isUTC) {
  ...
  if (isLeapYear(_year) && _month === 1 && _date === 29) {
    ...
    isUTC
      ? date.setUTCFullYear(value, _month, _daysInMonth)
      : date.setFullYear(value, _month, _daysInMonth);
  }
